...
if($con){
    echo "Massage successfuly send........";
    echo "<br>";
    echo "Do you want to Registrstion? Click the join button";
}else{
    echo "NO Conenction";
}
mysqli_select_db($con, 'gust');
...
$query = "  insert into gustuser (Name, Mobile, Email, Comment) 
  ...
  <section id="join">
    <div class="container">
      <div class="join text-center">
        ...
        <a class="btn home-btn" href="login.php"> JOIN NOW </a>
      </div>
    </div>
  </section>
  <!----------------About us section------------->
